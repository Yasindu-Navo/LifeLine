                    ...
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block" id="limage">
                                ...
                                <p class="plogin text-center">This Is The Mission To Help <br /> The Helpless</p>
                            </div>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST" action="../Login_page/includes/Login.php">
                                        ...
                                        <div class="form-floating  form-outline mb-2">
                                            ...
                                            <input type="text" id="uname" name="username" placeholder="User Name" class="form-control form-control-lg" />
                                            <label for="uname" class="ms-2"> User Email</label>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 pb-lg-2">Don't have an account? <a href="user_signin2.php" class="text-decoration-none">Register here</a></p>
                                        </div>
                                    </form>
